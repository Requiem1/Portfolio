...
void DITEM::SetBullet(D3DXVECTOR3 *m_pForward, D3DXVECTOR3 *m_ParantPos)
{
	m_forward = (*m_pForward);
	m_pos = (*m_ParantPos);
}

void DITEM::VertexBuffer(LPDIRECT3DVERTEXBUFFER9 & pVb, LPDIRECT3DINDEXBUFFER9 & pIb, vector<VERTEX_PC>& vecVertex, vector<WORD>& vecIndex)
{
